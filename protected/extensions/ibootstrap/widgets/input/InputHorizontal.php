 ...
 * @since 0.9.8
 */
class InputHorizontal extends Input
{
	/**
	 * Runs the widget.
	 */
	...
	protected function textArea()
	{
		echo $this->getLabel();
		echo '<div class="col-sm-10">';
		// Class name 'form-control' is from Bootstrap's Horizontal form style
		$this->htmlOptions['class'] .= ' form-control';
	...
	protected function staticField()
	{
		$this->htmlOptions['class'] .= ' form-control';

		echo $this->getLabel();
		echo '<div class="col-sm-10">';
		echo $this->htmlOptions['id'] ? '<p class="form-control-static" id="'.$this->htmlOptions["id"].'"></p>' : '<p class="form-control-static"></p>';
		echo '</div>';
	}
