...
Yii::import('bootstrap.widgets.input.Input');
...
class ActiveForm extends CActiveForm
{
	...
	// Input classes.
	const INPUT_HORIZONTAL = 'bootstrap.widgets.input.InputHorizontal';
	const INPUT_INLINE = 'bootstrap.widgets.input.InputInline';
	const INPUT_SEARCH = 'bootstrap.widgets.input.InputSearch';
	const INPUT_VERTICAL = 'bootstrap.widgets.input.InputVertical';
	...
	{
		return $this->inputRow(Input::TYPE_CHECKBOX, $model, $attribute, null, $htmlOptions);
	}
	...
	{
		return $this->inputRow(Input::TYPE_CHECKBOXLIST, $model, $attribute, $data, $htmlOptions);
	}
	...
	{
		return $this->inputRow(Input::TYPE_CHECKBOXLIST_INLINE, $model, $attribute, $data, $htmlOptions);
	}
	...
	{
		return $this->inputRow(Input::TYPE_DROPDOWN, $model, $attribute, $data, $htmlOptions);
	}
	...
	{
		return $this->inputRow(Input::TYPE_FILE, $model, $attribute, null, $htmlOptions);
	}
	...
	{
		return $this->inputRow(Input::TYPE_PASSWORD, $model, $attribute, null, $htmlOptions);
	}
	...
	{
		return $this->inputRow(Input::TYPE_RADIO, $model, $attribute, null, $htmlOptions);
	}
	...
	{
		return $this->inputRow(Input::TYPE_RADIOLIST, $model, $attribute, $data, $htmlOptions);
	}
	...
	{
		return $this->inputRow(Input::TYPE_RADIOLIST_INLINE, $model, $attribute, $data, $htmlOptions);
	}
	...
	{
		return $this->inputRow(Input::TYPE_TEXT, $model, $attribute, null, $htmlOptions);
	}
	public function staticRow($model, $attribute, $htmlOptions = array())
	{
		return $this->inputRow(Input::TYPE_STATIC, $model, $attribute, null, $htmlOptions);
	}
	...
	{
		return $this->inputRow(Input::TYPE_TEXTAREA, $model, $attribute, null, $htmlOptions);
	}
	...
	{
		return $this->inputRow(Input::TYPE_CAPTCHA, $model, $attribute, null, $htmlOptions);
	}
	...
	{
		return $this->inputRow(Input::TYPE_UNEDITABLE, $model, $attribute, null, $htmlOptions);
	}
	...
	protected function inputsList($checkbox, $model, $attribute, $data, $htmlOptions = array())
	{
		...
		//$labelCssClass = $checkbox ? 'checkbox-inline' : 'radio-inline';
