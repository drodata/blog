...
class Bootstrap extends CApplicationComponent
{
	...
	public function registerIonIconsCss()
	{
		Yii::app()->clientScript->registerCssFile($this->getAssetsUrl().'/css/ionicons.css');
		Yii::app()->clientScript->registerCssFile($this->getAssetsUrl().'/css/icheck/minimal.css');
	}
	public function registerFontAwesomeCss()
	{
		Yii::app()->clientScript->registerCssFile($this->getAssetsUrl().'/font-awesome/css/font-awesome.min.css');
	}
	public function registerDrodataCss()
	{
		//Yii::app()->clientScript->registerCssFile($this->getAssetsUrl().'/css/drodata.css');
	}
	...
	public function registerAllCss()
	{
		...
		$this->registerIonIconsCss();
		$this->registerFontAwesomeCss();
		$this->registerYiiCss();
		$this->registerDrodataCss();
	}
	...
	protected function registerJS($position = CClientScript::POS_HEAD)
	{
		...
		$cs->registerScriptFile($this->getAssetsUrl().'/js/icheck.min.js', $position);
	}
